...
class Network:
    ...
    def get(self):
        ...
        if self.train_config.MODEL == self.train_config.UNET:
            return Unet(self.train_config.train_cropped_images_path, self.train_config.channels, input_size=(self.train_config.img_width, self.train_config.img_height, self.train_config.channels), pretrained_weights=None)
