...
class CCGAN():
    def __init__(self):
        self.img_rows = configurations.img_height
        self.img_cols = configurations.img_width
        self.channels = 1
    ...
    def train(self, model, noisy_input_train, pure_input_train, epochs=50, batch_size=128, sample_interval=50):

        # Load the dataset
        # X_train = noisy
        # y_train = pure
        #(X_train, y_train), (_, _) = mnist.load_data()
        X_train, y_train = noisy_input_train, pure_input_train
        ...
        for epoch in range(epochs):
            ...
            g_loss = model.train_on_batch(masked_imgs, valid)
